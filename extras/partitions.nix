  ...
  partitionModule = { config, options, name, ... }: {
    options = {
      ...
      module = mkOption {
        ...
        default = { };
        description = ''
          A re-evaluation of the snowflake top level modules.
...
in
{
  options = {
    partitionedAttrs = mkOption {
      ...
      default = { };
      description = ''
        A set of flake output attributes that are taken from a partition instead of the default top level snowflake evaluation.
